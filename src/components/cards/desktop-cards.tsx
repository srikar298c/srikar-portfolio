  ...
  return (
    ...
    >
      <button
        ...
        className="absolute z-50 p-3 text-gray-200 bg-zinc-800 rounded-full cursor-pointer pointer-events-auto bg-opacity-70 backdrop-filter backdrop-blur-lg top-4 right-4"
        aria-label="Close"
      >
        <X size={24} />
      </button>
